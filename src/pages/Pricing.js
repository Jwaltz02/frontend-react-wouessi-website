...
function Pricing() {
  return (
    <main>
      ...
      <section>
        <div className="text-center px-3 sm:px-6 lg:px-12 pt-4 pb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 mt-16">
            ...
            <div className="flex flex-col justify-between p-8 text-sm">
              ...
              <ul className="p-10 list-disc">
                <li className="py-4"><p>Responsive Website - Unlimited pages</p></li>
                <li className="py-4"><p>Social Media Management - Unlimited accounts / 3 months</p></li>
                <li className="py-4"><p>Competitors Analysis - 5 competitors</p></li>
                <li className="py-4"><p>Brochure Design- Unlimited Brochures</p></li>
                <li className="py-4"><p>Logo Design - 1 logo</p></li>
                <li className="py-4"><p>Paid Social Media - 1 month</p></li>
                <li className="py-4"><p>Paid Search - 1 month</p></li>
                <li className="py-4"><p>Email Marketing - 3 momth</p></li>
                <li className="py-4"><p>SEO strategiy - Full Stack</p></li>
              </ul>
              <div className="flex justify-center">
                <button className="w-[11vw] h-[4vw] rounded-md bg-[#2B00AC] text-white font-bold text-[1.1vw]">
                  Join This Plan
